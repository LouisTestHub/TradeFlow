...
export function FetfSection() {
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-r from-[#1E3A5F] to-[#2563EB]">
        ...
        <ScrollFadeIn>
          <div className="flex flex-col md:flex-row items-center gap-8 text-white">
            ...
            <div className="flex-1 text-center md:text-left">
              <p className="text-sm font-semibold uppercase tracking-wider text-blue-200 mb-2">🇬🇧 Built for UK Trades</p>
            ...
            <Link
              href="#pricing"
              className="flex-shrink-0 inline-flex items-center justify-center px-6 py-4 bg-[#F97316] text-white font-semibold rounded-xl hover:bg-[#EA580C] transition-colors min-h-[48px] whitespace-nowrap"
            >
              See Pricing →
            </Link>
          </div>
