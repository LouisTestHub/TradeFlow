...
// Field service compliance badges
...
function CisBadge({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 80 80" className={className} width={80} height={80}>
      <circle cx="40" cy="40" r="36" fill="#1B5E20" />
      <circle cx="40" cy="40" r="32" fill="white" />
      <text x="40" y="38" fontSize="11" fontWeight="700" fill="#1B5E20" textAnchor="middle" fontFamily="DM Sans">CIS</text>
      <text x="40" y="52" fontSize="5" fill="#1B5E20" textAnchor="middle" fontFamily="Inter">TAX READY</text>
    </svg>
  );
}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollFadeIn>
          <div className="text-center mb-10">
            <h2 className="font-[var(--font-dm-sans)] text-2xl sm:text-3xl font-bold text-[#1E293B]">
